...
<?php
	require_once ('connect.php');
	$ReadSql = "SELECT * FROM `code_activation` ";
			...
			<tbody>
				<?php
				 ...
				 while($row=mysqli_fetch_assoc($result)){
				   ...
				   <td>
				   <button class="btn btn-primary"><a href="UPDATE.php?updateid='.$row['id_codeActivation'].'" class="text-light">Mettre à jour</a></button>
				   <button class="btn btn-danger"><a href="delete.php?deleteid='.$row['id_codeActivation'].'" class="text-light">Supprimer</a></button>
				   </td>
				   </tr>'; 
				 }
				 } ?>
