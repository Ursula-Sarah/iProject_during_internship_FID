...
require_once ('connect.php');
		if (isset($_POST) & !empty($_POST)||isset($id_activation)||isset($id_machine)||isset($id_codeActivation)) {
			...
			$date_fin=($_POST['date_expiration']);
			$CreateSql = "INSERT INTO `activation` (id_activation,id_codeActivation,id_machine,date_activation,nombre_jour_restant,date_expiration)  VALUES(NULL,'$id_codeActivation', '$id_machine','$date_activation','$nombre_jour','$date_fin') ";
		...
		<div class="row pt-4">
			...
			<form action="" method="POST" class="form-horizontal col-md-6 pt-4">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						foreach($result as $row){
							echo '<option value="'.$row["id_machine"].'">'.$row['id_machine'].'</option>';
						}
						?>
					</select>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" name="jour" placeholder="nombre de jours restant" class="form-control" id="input1">
					</div>
				</div>
				<div class="form-group">
					<label for="input1" class="col-sm-2 control-label">exp</label>
					<div class="col-sm-10">
						<input type="text" name="date_expiration" placeholder="exp" class="form-control" id="input1">
					</div>
				</div>
...
<body>
	...
	<div class="container">
		<div class="row pt-4">
			<h2>Tableau du code d'activation</h2>
		</div>
			...
			<tbody>
				<?php
				 ...
				 while($row=mysqli_fetch_assoc($result)){
				   ...
				   $date_fin=$row['date_expiration'];
				  
				   $nombre_jour=(strtotime($date_fin)-strtotime($date))/60/60/24;
				   if($nombre_jour>=10||$nombre_jour<=20){
					echo '<script language="Javascript">
					alert("La licence de la machine '.$id_machine.' est presque expirée")
					</script>';
				   }if($nombre_jour<=0){
					$nombre_jour=0;
					echo '<script language="Javascript">
